(function () {
    ...
    var functionsItems = [
        ...
        {
            "name": "Add price to Database",
            "description": "",
            "groups": "all",
            "func": "add_price_history()"
        },
        {
            "name": "Add fx rate to Database",
            "description": "",
            "groups": "all",
            "func": "add_fx_history()"
        },
        {
            "name": "Get FX rate as of <date>",
            "description": "",
            "groups": "all",
            "func": "get_fx_rate()"
        },
        {
            "name": "Get instrument accrued price as of <date>",
            "description": "",
            "groups": "all",
            "func": "get_accrued_price()"
        },
        {
            "name": "Get instrument principal price as of <date>",
            "description": "",
            "groups": "all",
            "func": "get_principal_price()"
        },
        {
            "name": "Get Instr factor as of <date>",
            "description": "",
            "groups": "all",
            "func": "get_factor()"
        },
