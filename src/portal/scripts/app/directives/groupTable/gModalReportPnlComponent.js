...
(function () {
    ...
    module.exports = function ($scope, $mdDialog, entityViewerDataService, entityViewerEventService) {
        ...
        vm.getAttributes = function () {
            ...
            vm.balanceAttrs = rvAttributesHelper.getAllAttributesAsFlatList('reports.plreport', '', 'Balance', {maxDepth: 1});

            vm.balanceMismatchAttrs = rvAttributesHelper.getAllAttributesAsFlatList('reports.plreportmismatch', '', 'Mismatch', {maxDepth: 1});

            vm.balancePerformanceAttrs = rvAttributesHelper.getAllAttributesAsFlatList('reports.plreportperfomance', '', 'Perfomance', {maxDepth: 1});
