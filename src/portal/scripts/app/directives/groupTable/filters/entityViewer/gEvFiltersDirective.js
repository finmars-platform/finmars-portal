		...
		return {
			...
			link: function (scope, elem, attrs, gFiltersVm) {
				...
				scope.getClasses = function () {
					...
					if (scope.thereAreFrontendFilters && scope.shownFiltersType === 'frontend') {
						classes = 'hide-ev-front-filters';
					}

					/*if (scope.entityType === 'generated-event') {
						classes = classes + ' g-filter-minimal';
					}*/
