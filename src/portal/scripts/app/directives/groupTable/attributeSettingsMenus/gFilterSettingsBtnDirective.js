    ...
    module.exports = function () {
        return {
            ...
            link: function (scope, elem, attrs) {
				...
				scope.filterPopupTemplate = isReport ? 'views/popups/groupTable/filters/rv-filter-popup-view.html' : 'views/popups/groupTable/filters/ev-filter-popup-view.html';
