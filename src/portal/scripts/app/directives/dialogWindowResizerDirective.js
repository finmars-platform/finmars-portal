        ...
        return {
            ...
            link: function (scope, elem, attrs) {
                ...
                var resizeDialogWindow = function (event) {
                    ...
                    scope.elemToResize.style.width = (dialogElemWidth + xPos - initXPos) + 'px';
                    scope.elemToResize.style.height = (dialogElemHeight + yPos - initYPos) + 'px';
                ...
                scope.startDialogWindowResize = function ($event) {
                    dialogElemWidth = JSON.parse(JSON.stringify(scope.elemToResize.clientWidth));
                    dialogElemHeight = JSON.parse(JSON.stringify(scope.elemToResize.clientHeight));
