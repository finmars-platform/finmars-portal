...
(function () {
    ...
    module.exports = function settingsGeneralDataProvidersBloombergController($scope, $stateParams, $mdDialog, $state) {
        ...
        vm.saveConfig = function ($event) {
            ...
            if (!vm.wronExtensions) {
                if (vm.item.id) {
                    ...
                    bloombergDataProviderService.updateCredential(vm.item.id, formData).then(function (data) {
                    ...
                    bloombergDataProviderService.createCredential(formData).then(function (data) {
        ...
        vm.getItem = function () {
            ...
            bloombergDataProviderService.getCredentialByKey(vm.itemId).then(function (data) {
