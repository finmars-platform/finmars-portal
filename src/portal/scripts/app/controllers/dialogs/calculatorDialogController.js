    ...
    module.exports = function ($scope, $mdDialog, data) {
        ...
        vm.applyOperator = function(operator) {
            ...
            if (currentNumber) {
                ...
                if (prevNumber) { // if operator was added when there is already data to perform calculation (prevNumber, operatorType and currentNumber)
                ...
                if (vm.calculationsHistory) { // change operator if second number for operation is not set yet
