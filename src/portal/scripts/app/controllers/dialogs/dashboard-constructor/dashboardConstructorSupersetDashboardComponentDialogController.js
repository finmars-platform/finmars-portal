...
(function () {
    ...
    module.exports = function dashboardConstructorSupersetDashboardComponentDialogController($scope, $mdDialog, metaContentTypesService, uiService, dashboardConstructorMethodsService, item, dataService, eventService) {
