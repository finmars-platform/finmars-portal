    ...
    module.exports = function ($scope, $mdDialog, toastNotificationService, currencyHistoryService, data) {
        ...
        vm.saveGroup = function ($event, group) {
            ...
            group.items.forEach(function (item) {
                ...
                if (item.fx_rate) {
                    ...
                    promises.push(currencyHistoryService.create({
            ...
            Promise.all(promises).then(function (data) {
                ...
                vm.items = vm.items.filter(function (item) {
                    ...
                    data.forEach(function (dataItem) {
                        ...
                        if (dataItem.date === item.accounting_date &&
                            dataItem.currency === item.transaction_currency_id &&
                            dataItem.pricing_policy_object.user_code === item.pricing_policy_user_code) {
        ...
        vm.generateGroupItems = function () {
            ...
            vm.items.forEach(function (item) {
                ...
                var key = item.transaction_currency_id + '_' + item.pricing_policy_user_code;
