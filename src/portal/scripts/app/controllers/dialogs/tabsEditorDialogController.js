        ...
        vm.tabsDragAndDrop = {
            ...
            eventListeners: function () {
                ...
                drake.on('drop', function (elem, target) {
                    ...
                    var tabsCardsElems = document.querySelectorAll('.tab-editor-dialog .tab-editor-tab-card');
                    var tabsAfterDrag = [];
            ...
            dragula: function () {
                ...
                var items = [document.querySelector('.tab-editor-dialog .tabs-dnd-container')];
