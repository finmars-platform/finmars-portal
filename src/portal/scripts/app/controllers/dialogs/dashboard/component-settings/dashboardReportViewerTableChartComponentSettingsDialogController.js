...
(function () {
    ...
    module.exports = function ($scope, $mdDialog, item, data) {
        ...
        vm.availableTitleColumnAttrs = vm.item.user_settings.available_title_column_keys;
        vm.availableValueColumnAttrs = vm.item.user_settings.available_value_column_keys;
