(function () {
    ...
    module.exports = function ($scope, $mdDialog, data) {
        ...
        var setItemsContainersHeight = function () { // for collapse animation
        ...
        var init = function () {
            ...
            if (vm.isMultiselector) {
                ...
                vm.toggleItem = function (group, item) {
                    ...
                    if (!item.isActive && activeItem) { // deactivate previous active item
                        vm.groups[activeItem.gOrder].content[activeItem.iOrder].isActive = false
                    }
