                ...
                if (vm.config.error_handler === 'break') {
                    ...
                    $mdDialog.show({
                        ...
                        locals: {
                            warning: {
                                title: 'Warning',
                                description: 'Please note that only valid rows until the first invalid row will be imported. The invalid row and the further rows, whether valid or not, will be excluded from the imported data',
                                actionsButtons: [
                                    {
                                        name: "CANCEL",
                                        response: {}
                ...
                if (vm.config.error_handler === 'continue') {
                    ...
                    $mdDialog.show({
                        ...
                        locals: {
                            warning: {
                                title: 'Warning',
                                description: 'Please note that only valid rows will be imported. The invalid rows will be excluded from the imported data.',
                                actionsButtons: [
                                    {
                                        name: "CANCEL",
                                        response: {}
