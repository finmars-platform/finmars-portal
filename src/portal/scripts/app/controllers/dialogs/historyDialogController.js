    ...
    module.exports = function ($scope, $mdDialog, globalDataService, data) {
        ...
        vm.updateSelected = function (record) {
            ...
            setTimeout(function () {
                ...
                vm.activeHistoryRecord.data_pretty = JSON.stringify(vm.activeHistoryRecord.data, null, 4)

                vm.delta = jsondiffpatch.diff(vm.entity, vm.activeHistoryRecord.data);

                vm.delta_pretty = JSON.stringify(vm.delta, null, 4)

                document.querySelector('.history-dialog-delta-visual').innerHTML = jsondiffpatch.formatters.html.format(vm.delta, vm.entity);
            }, 100)
        }
