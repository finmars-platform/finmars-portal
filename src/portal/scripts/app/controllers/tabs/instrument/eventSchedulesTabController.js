...
(function () {
    ...
    module.exports = function eventSchedulesTabController($scope, $mdDialog, instrumentService, gridTableHelperService) {
        ...
        var onEventsTableDeleteRows = function (argObj) {
            ...
            vm.entity.event_schedules = vm.entity.event_schedules.filter(function (event) {
        ...
        var formatDataForEventsGridTable = function () {
            ...
            vm.eventsGridTableData.header.columns = rowObj.columns.map(function (column) {
        ...
        var initGridTableEvents = function () {
			...
			vm.eventSchedulesGridTableEventService.addEventListener(gridTableEvents.CELL_VALUE_CHANGED, function (argObj) {
				eventsTableChangedHere = true;
				instrumentService.onGtCellChange(argObj, vm.entity, vm.eventSchedulesGridTableDataService, vm.evEditorEventService, 'event_schedules');
			});

			vm.eventSchedulesGridTableEventService.addEventListener(gridTableEvents.ROW_DELETED, function (argObj) {
				eventsTableChangedHere = true;
