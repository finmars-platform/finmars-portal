...
(function () {
	...
	module.exports = function ($scope, $mdDialog) {
		...
		// if (vm.reportAttrs.length === 0) {	// download dynamic attributes of reports for returnFullAttributes function
		// 	console.log();
		// 	var promises = [];
		// 	var attr = [];
		...
		// 				return item;
		// 			});
		// 			vm.reportAttrs = vm.reportAttrs.concat(reportAttrsResults);

		// 		});
		// 		console.log('report returnfullattributes reportAttrs', vm.reportAttrs);
		...
		vm.transformViewAttributes = function () { //deprecated
			...
			// vm.filters = returnFullAttributes(vm.filters, vm.attrs, vm.baseAttrs, vm.entityAttrs, vm.entityType); // filters activity
		...
		vm.getAttributes = function () {
			return attributeTypeService.getList(vm.entityType).then(function (data) {
				console.log('entity for attributes is: ', vm.entityType);
