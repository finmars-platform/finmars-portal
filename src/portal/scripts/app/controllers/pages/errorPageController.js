...
(function () {
    ...
    var errorRecordService = require('../../services/errorRecordService');
    ...
    module.exports = function dataStatsController($scope, authorizerService, globalDataService, $mdDialog) {
        ...
        vm.getExportLogsUrl = function () {
            ...
            if (vm.query) {
                return baseUrl + '/' + prefix + '/' + apiVersion + '/errors/error/export?query=' + vm.query
            } else {
