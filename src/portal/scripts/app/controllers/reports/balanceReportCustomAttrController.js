...
(function () {
    ...
    module.exports = function ($scope, $mdDialog) {
        ...
        vm.addAttribute = function (ev) {
            $mdDialog.show({
                controller: 'BalanceReportAddDialogCustomAttrController as vm',
                ...
                if (res.status === 'agree') {
                    ...
                    balanceReportCustomAttrService.create(vm.entityType, res.data.attribute).then(getList);
                }
            });
        };
        ...
        vm.editAttr = function (item, ev) {
            $mdDialog.show({
                ...
                if (res.status === 'agree') {
                    console.log("res", res.data);
                    balanceReportCustomAttrService.update(vm.entityType, res.data.attribute.id, res.data.attribute).then(getList);
                }
            });
        };
        ...
        vm.deleteAttr = function (item, ev) {
            ...
            $mdDialog.show({
                ...
                console.log('res', res);
                if (res.status === 'agree') {
                    balanceReportCustomAttrService.deleteByKey(vm.entityType, item.id).then(function (data) {
