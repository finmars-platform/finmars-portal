...
(function () {
    ...
    var updatePricing = function (id, data) {
        ...
        return xhrService.fetch(baseUrl + '/' + prefix + '/' + apiVersion + '/' + 'portfolios/portfolio-type/' + id + '/update-pricing/',
            {
                method: 'PUT',
                credentials: 'include',
                headers: {
    ...
    var bookInstrument = function (instrument_type_id) {
        ...
        return xhrService.fetch(baseUrl + '/' + prefix + '/' + apiVersion + '/' + 'portfolios/portfolio-type/' + instrument_type_id + '/book/',
            {
                method: 'GET',
                credentials: 'include',
                headers: {
