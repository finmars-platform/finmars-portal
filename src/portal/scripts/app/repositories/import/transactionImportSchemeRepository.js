...
return xhrService.fetch(configureRepositoryUrlService.configureUrl(baseUrl   +  '/' + prefix + '/' + apiVersion + '/' + 'import/complex-transaction-import-scheme/light/', options),
            {
                method: 'GET',
                credentials: 'include',
                headers: {
...
return xhrService.fetch(baseUrl   +  '/' + prefix + '/' + apiVersion + '/' + 'import/complex-transaction-import-scheme/',
            {
                method: 'POST',
                credentials: 'include',
                headers: {
...
return xhrService.fetch(baseUrl   +  '/' + prefix + '/' + apiVersion + '/' + 'import/complex-transaction-import-scheme/' + id + '/',
            {
                method: 'GET',
                credentials: 'include',
                headers: {
