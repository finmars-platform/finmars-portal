(function () {
    ...
    function weightedMarketValue(flatListItem,  valueInTotal, numberKey) {
        ...
        if (flatListItem.hasOwnProperty("market_value") && !isNaN(parseFloat(flatListItem["market_value"]))) {

            if (!isNaN(parseFloat(flatListItem[numberKey]))) {

                result = result + parseFloat(flatListItem[numberKey]) * parseFloat(flatListItem["market_value"]);
    ...
    function weightedMarketValuePercent(flatListItem,  valueInTotal, numberKey) {
        ...
        if (flatListItem["market_value_percent"] && !isNaN(parseFloat(flatListItem["market_value_percent"]))) {
    ...
    function weightedExposurePercent(flatListItem,  valueInTotal, numberKey) {
        ...
        if (flatListItem["exposure_percent"] && !isNaN(parseFloat(flatListItem["exposure_percent"]))) {
    ...
    function weightedAverageMarketValue(flatList, flatListItem, valueInTotal, numberKey) {
    ...
    function weightedAverageMarketValuePercent(flatList, flatListItem, valueInTotal, numberKey) {
    ...
    function weightedAverageExposure(flatList, flatListItem, valueInTotal, numberKey) {
    ...
    function weightedAverageExposurePercent(flatList, flatListItem, valueInTotal, numberKey) {
    ...
    var calculateFieldValues = function (itemList, flatListItem, valueInTotal, numberKey, calcFormulaId) {
        ...
        switch (calcFormulaId) {
            ...
            case 6:
                return weightedAverageMarketValue(itemList, flatListItem, valueInTotal, numberKey);
            case 7:
                return weightedAverageMarketValuePercent(itemList, flatListItem, valueInTotal, numberKey);
            case 8:
                return weightedAverageExposure(itemList, flatListItem, valueInTotal, numberKey);
            case 9:
    ...
    var getDataForChartsFromFlatList = function (itemList, nameKey, numberKey, calcFormulaId) {
        ...
        itemList.forEach(function (item) {
            ...
            if (item[nameKey]) {
                ...
                if (savedNames.indexOf(nameValue) === -1) {
                    ...
                    numberValue = calculateFieldValues(itemList, item, numberValue, numberKey, calcFormulaId);
