(function () {
    ...
    var getNextPage = function (options, event, entityViewerDataService) {
        ...
        if (!event.groupId) {
            ...
            groupData = entityViewerDataService.getData(event.groupId);
        }
    ...
    var ifFirstRequestForRootGroup = function (event, evDataService) {
        ...
        if (!event.groupId) {
            ...
            groupData = evDataService.getData(event.groupId);
        }
    ...
    var getProjection = function (evDataService) {
        ...
        // console.log('getProjection.reserveTop', reserveTop);
        // console.log('getProjection.reserveBottom', reserveBottom);
        // console.log('getProjection.flatList.length', flatList.length);
        // console.log('getProjection.from', from);
        // console.log('getProjection.to', to);

        // var items = flatList.slice(offset, offset + step);
        var items = flatList.slice(from, to);

        // console.log('getProjection.items.length', items.length);
