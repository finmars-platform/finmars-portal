...
(function () {
    ...
    var functionsItemsService = require('../../../content/services/functionsItems');
    var functionsGroupsService = require('../../../content/services/functionsGroups');
    ...
    var validateExpression = function (exprItem, data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            expressionService.validate(exprItem).then(function (responseData) { // may be useless

                htmlExpressionData = getHtmlExpression(exprItem.expression, data, expressionsList);
