...
(function () {
    ...
    var renderHeadContent = function () {
        ...
        result = result + "<div class='developer-console-head-row'>Session Time: " + sessionTimeInMinutes + "m " + sessionTimeInSeconds + "s</div>";

        result = result + "<div class='developer-console-column-holder'>";

        result = result + "<div class='developer-console-head-column'>";
        result = result + "<div>Total Requests: <span class='developer-console-head-column-value'>" + requestCounter + "</span></div>";
        result = result + "<div>Pending Requests: <span class='developer-console-head-column-value'>" + pendingRequests + "</span></div>";
        result = result + "</div>";

        result = result + "<div class='developer-console-head-column'>";
        result = result + "<div>Success Requests: <span class='developer-console-head-column-value'>" + successRequests + "</span></div>";
        result = result + "<div class='developer-console-color-red'>Error Requests: <span class='developer-console-head-column-value'>" + errorRequests + "</span></div>";
        result = result + "</div>";
    ...
    var renderBodyContent = function () {
        ...
        result = result + "<div class='developer-console-requests-row-content-length'>Size</div>";
        result = result + "<div class='developer-console-requests-row-processing-time'>Time</div>";

        result = result + "</div>";

        result = result + "<div class='developer-console-requests-container-scrollable'>";
        ...
        requests.forEach(function (item) {
            ...
            row = row + "<div class='developer-console-requests-row-url' title='" + url + "'>" + url + "</div>";
            row = row + "<div class='developer-console-requests-row-content-length'>" + size + "</div>";
            row = row + "<div class='developer-console-requests-row-processing-time'>" + time + "</div>";
    ...
    var renderConsole = function () {
        ...
        setTimeout(function () {
            ...
            var scrollableContainer = document.querySelector('.developer-console-requests-container-scrollable');
