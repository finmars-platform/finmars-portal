...
app.controller('LayoutChangesLossWarningDialogController', ['$scope', '$mdDialog', require('./app/controllers/dialogs/layoutChangesLossWarningDialogController')]);
