        ...
        vm.activateDatabase = function (item) {
            ...
            profileAuthorizerService.setCurrentMasterUser(item.id).then(function (data) {
                ...
                if (data.base_api_url) {
                    ...
                    // }
                    console.log("opendatabase activateDatabase 1.1", data);
                    $state.go('app.portal.home');

                }
				else {
                    console.log("opendatabase activateDatabase 2", data);
                    $scope.$apply();

                    console.log("Error activate", data)

                    if (data.message) {
                        console.log("opendatabase activateDatabase 2.1", data.message);
                ...
                console.log("opendatabase activateDatabase catch", error);
                vm.openProcessing = false;
